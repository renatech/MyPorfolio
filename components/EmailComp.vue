<template>
  <div class="mail">
    <a class="link" href="mailto:samuelserenaluv@gmail.com">
      samuelserenaluv@gmail.com
    </a>
...
.mail .link {
  @apply text-gray-400 hover:text-primary-700 font-mono;
}
...
@screen lg {
  ...
  .mail .divider {
    @apply block border-l-2 flex-grow;
  }
}
</style>
